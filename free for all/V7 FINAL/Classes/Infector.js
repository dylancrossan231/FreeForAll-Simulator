class Infector extends Molecule{
    ...
    recovered() {
        setTimeout(() => {
            ...
            //then runs code inside of setTimeout and makes a new recovered molecule at the same array position x and y position same velocity and radius
    ...
    //If Healthy becomes infected it takes the same array position and velocity and radius as its previous counter part.
